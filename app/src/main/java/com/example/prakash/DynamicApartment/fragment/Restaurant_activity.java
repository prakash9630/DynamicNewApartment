...
import com.example.prakash.DynamicApartment.Pojo.Place_data;
import com.example.prakash.DynamicApartment.Public_url;
import com.example.prakash.DynamicApartment.R;
import com.example.prakash.DynamicApartment.activity.Place_detail;
                ...
                for (int i = 0; i < response.length(); i++) {
                    ...
                    try {
                        ...
                        if (attractionrestaurant.equals("Restaurants"))
                        {
                            ...
                            data=new Place_data(Nid,name,filename,attractionrestaurant);
                            arraylist.add(data);
...
class RestaurantAdapter extends RecyclerView.Adapter<RestaurantHolder>
{
    ...
    public void onBindViewHolder(RestaurantHolder holder, int position) {
        ...
        Picasso.with(contex)
                .load("http://template.nuza.solutions/sites/default/files/"+current.getImage())
