...
import com.example.prakash.DynamicApartment.Pojo.Appartment_type_data;
...
//        pDilog=new ProgressDialog(getActivity(),R.style.MyTheme);
...
//
                        ...
                        Toast.makeText(getContext(), "Exception occur", Toast.LENGTH_LONG).show();
